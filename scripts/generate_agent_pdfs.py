"""
Enhanced PDF Generator for CORE Sub-Agents
Generates publication-grade, multi-page technical PDF documentation for all 6 sub-agents.
"""
import os
import sys
...
OUTPUT_DIR = "/home/avinash/.gemini/antigravity/scratch/cyber -orchestration/docs/agents/pdf"
    ...
    },
    {
        ...
        "sections": [
            ...
            ("2. Supported GRC Framework Datasets (YAML)", [
                ...
                "NIST SP 800-53 Rev 5: Maps to Control Families AC (Access Control), SI (System & Information Integrity), and SC (System & Communications Protection).",
...
def generate_pdf(doc_info):
    ...
    pdf_path = os.path.join(OUTPUT_DIR, doc_info["filename"])
    ...
    footer_text = Paragraph("<font color='#64748B' size=8>CORE (Cyber Orchestration and Remediation Engine) — Comprehensive Technical Documentation PDF</font>", styles['Normal'])
    elements.append(footer_text)
    
    doc.build(elements)
    print(f"✅ Generated Enhanced PDF: {pdf_path}")

if __name__ == "__main__":
    for doc in ENHANCED_AGENT_DOCS:
        generate_pdf(doc)
